...
A GraphQL API example built with [GraphQL Yoga](https://the-guild.dev/graphql/yoga-server) — a fully-featured, simple to set up, performant and extendable GraphQL server.
...
```bash
git clone https://github.com/GetWebstack-public/nodejs-graphql-yoga
